  ...
  return (
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl ">
      ...
      <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
        <div className="bg-discord-brand-color size-12 rounded-2xl flex items-center justify-center mb-2 hover:rounded-xl transition-all duration-200 ">
        ...
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="size-12 bg-discord-background rounded-s-3xl flex items-center justify-center mb-3 hover:rounded-lg transition-all duration-200 hover:bg-discord-brand-color cursor-not-allowed"
          >
        ...
        <div className="group mt-auto size-12 bg-discord-background rounded-s-3xl flex items-center justify-center mb-3 hover:rounded-lg transition-all duration-200 hover:bg-[#3ba55c] cursor-not-allowed">
      ...
      <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          <div className="px-2 mb-4">
            <div className="flex items-center text-sm px-2 py-1.5 rounded hover:bg-[#393c43] text-[#dcddde] cursor-not-allowed">
              <UserCircle className="mr-4 size-8 text-[#b9bbe]" />
              <span className="font-medium text-sm">Friends</span>
            </div>
            <div className="flex items-center text-sm px-2 py-1.5 rounded hover:bg-[#393c43] text-[#dcddde] cursor-not-allowed">
              <Inbox className="mr-4 size-8 text-[#b9bbe]" />
              <span className="font-medium text-sm">Nitro</span>
            </div>
          </div>

          <div className="px-2 mb-4">
            <h3 className="text-xs font-semibold text-[#8c9297] mb-2 uppercase">
              Direct Messages
            </h3>
            ...
            <div className="my-1 space-y-px">
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className="flex items-center px-1 py-1.5 rounded text-gray-600 cursor-not-allowed"
                >
        ...
        <div className="p-2 bg-[#292b2f] flex items-center">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-[#b9bbbe] flex items-center">
              @your_accout
            </p>
          </div>
